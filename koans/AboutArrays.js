describe("About Arrays", function() {
  ...
  //Método .slice()retorna uma cópia de parte de um array a
  // partir de um subarray criado entre as posições início e fim(fim não é incluído)
  ...
  it("should push and pop", function () {
    ...
    expect(poppedValue).toBe(poppedValue);
    expect(array).toEqual(array);
  });
  ...
  it("should know about shifting arrays", function () {
    ...
    expect(shiftedValue).toEqual(shiftedValue);
    expect(array).toEqual(array);
  });
});
